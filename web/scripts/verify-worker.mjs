...
// and rejects the removed exploration worker architecture:
...
if (explorationFile) {
  console.error(`FAIL: obsolete whole-design exploration worker was emitted: ${explorationFile}`)
  process.exit(1)
}
console.log('PASS: no obsolete whole-design exploration worker was emitted')
